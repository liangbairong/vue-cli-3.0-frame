...
export var createPeerid = () => {
  ...
  return getRandomString(4, false, true) + rn + ts.toString(36) + mn + getRandomString(6, false, true);
};
...
export var $CDN_IMG = (path) => {
  return `http://${RandomNumBoth(1,3)}.${process.env.VUE_APP_IMGCDN_SUFFIX}/${path}`
};
